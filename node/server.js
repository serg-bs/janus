...
var D__projects_webrtc_node_modules_depd_lib_compat = createCommonjsModule(function (module) {
...
var callSiteToString$1 = D__projects_webrtc_node_modules_depd_lib_compat.callSiteToString;
var eventListenerCount$1 = D__projects_webrtc_node_modules_depd_lib_compat.eventListenerCount;
var relative = path$2__default.relative;

/**
 * Module exports.
 */

var D__projects_webrtc_node_modules_depd = depd;
...
var D__projects_webrtc_node_modules_bytes = bytes;
var format_1 = format;
var parse_1 = parse;
...
D__projects_webrtc_node_modules_bytes.format = format_1;
D__projects_webrtc_node_modules_bytes.parse = parse_1;
...
var D__projects_webrtc_node_modules_contentType = {
	format: format_1$1,
	parse: parse_1$1
};
...
var D__projects_webrtc_node_modules_statuses = status;
...
var D__projects_webrtc_node_modules_toidentifier = toIdentifier;
...
var D__projects_webrtc_node_modules_httpErrors = createCommonjsModule(function (module) {
...
var deprecate = D__projects_webrtc_node_modules_depd('http-errors');
...
populateConstructorExports(module.exports, D__projects_webrtc_node_modules_statuses.codes, module.exports.HttpError);
...
function createError () {
  ...
  if (typeof status !== 'number' ||
    (!D__projects_webrtc_node_modules_statuses[status] && (status < 400 || status >= 600))) {
    status = 500;
  }
  ...
  if (!err) {
    ...
    err = HttpError
      ? new HttpError(msg)
      : new Error(msg || D__projects_webrtc_node_modules_statuses[status]);
...
function createClientErrorConstructor (HttpError, name, code) {
  ...
  function ClientError (message) {
    ...
    var msg = message != null ? message : D__projects_webrtc_node_modules_statuses[code];
...
function populateConstructorExports (exports, codes, HttpError) {
  codes.forEach(function forEachCode (code) {
    var CodeError;
    var name = D__projects_webrtc_node_modules_toidentifier(D__projects_webrtc_node_modules_statuses[code]);
...
var D__projects_webrtc_node_modules_httpErrors_1 = D__projects_webrtc_node_modules_httpErrors.HttpError;
...
var D__projects_webrtc_node_modules_bodyParser_node_modules_ms = function(val, options) {
  options = options || {};
  var type = typeof val;
...
exports.humanize = D__projects_webrtc_node_modules_bodyParser_node_modules_ms;
...
safer$1.Buffer.prototype = Buffer$2.prototype;
...
var D__projects_webrtc_node_modules_iconvLite_encodings = createCommonjsModule(function (module, exports) {
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = D__projects_webrtc_node_modules_iconvLite_encodings; // Lazy load all encoding definitions.
...
var D__projects_webrtc_node_modules_unpipe = unpipe;
...
function getDecoder (encoding) {
  ...
  try {
    ...
    throw D__projects_webrtc_node_modules_httpErrors(415, 'specified encoding unsupported', {
      encoding: encoding,
...
function getRawBody (stream, options, callback) {
  ...
  var limit = D__projects_webrtc_node_modules_bytes.parse(opts.limit);
...
function halt (stream) {
  ...
  D__projects_webrtc_node_modules_unpipe(stream);
...
function readStream (stream, encoding, length, limit, callback) {
  ...
  if (limit !== null && length !== null && length > limit) {
    return done(D__projects_webrtc_node_modules_httpErrors(413, 'request entity too large', {
      expected: length,
      length: length,
      limit: limit,
  ...
  if (stream._decoder || (state && (state.encoding || state.decoder))) {
    // developer error
    return done(D__projects_webrtc_node_modules_httpErrors(500, 'stream encoding should not be set', {
  ...
  function onAborted () {
    ...
    done(D__projects_webrtc_node_modules_httpErrors(400, 'request aborted', {
      code: 'ECONNABORTED',
      expected: length,
      length: length,
      received: received,
  ...
  function onData (chunk) {
    ...
    if (limit !== null && received > limit) {
      done(D__projects_webrtc_node_modules_httpErrors(413, 'request entity too large', {
        limit: limit,
        received: received,
        type: 'entity.too.large'
      }));
  ...
  function onEnd (err) {
    ...
    if (length !== null && received !== length) {
      done(D__projects_webrtc_node_modules_httpErrors(400, 'request size did not match content length', {
        expected: length,
        length: length,
        received: received,
...
var D__projects_webrtc_node_modules_eeFirst = first;
...
var D__projects_webrtc_node_modules_onFinished = onFinished;
...
function attachFinishedListener(msg, callback) {
  ...
  eeMsg = eeSocket = D__projects_webrtc_node_modules_eeFirst([[msg, 'end', 'finish']], onFinish);
  ...
  function onSocket(socket) {
    ...
    eeSocket = D__projects_webrtc_node_modules_eeFirst([[socket, 'error', 'close']], onFinish);
  }
...
D__projects_webrtc_node_modules_onFinished.isFinished = isFinished_1;
...
function read (req, res, next, parse, debug, options) {
  ...
  if (opts.encoding === null && encoding !== null && !lib.encodingExists(encoding)) {
    return next(D__projects_webrtc_node_modules_httpErrors(415, 'unsupported charset "' + encoding.toUpperCase() + '"', {
  ...
  rawBody(stream, opts, function (error, body) {
    if (error) {
      ...
      if (error.type === 'encoding.unsupported') {
        // echo back charset
        _error = D__projects_webrtc_node_modules_httpErrors(415, 'unsupported charset "' + encoding.toUpperCase() + '"', {
          charset: encoding.toLowerCase(),
          type: 'charset.unsupported'
        });
      } else {
        // set status code on error
        _error = D__projects_webrtc_node_modules_httpErrors(400, error);
      }

      // read off entire request
      stream.resume();
      D__projects_webrtc_node_modules_onFinished(req, function onfinished () {
        next(D__projects_webrtc_node_modules_httpErrors(400, _error));
      });
      return
    }
    ...
    if (verify) {
      try {
        ...
        next(D__projects_webrtc_node_modules_httpErrors(403, err, {
          body: body,
    ...
    try {
      ...
      next(D__projects_webrtc_node_modules_httpErrors(400, err, {
        body: str,
...
function contentstream (req, debug, inflate) {
  ...
  if (inflate === false && encoding !== 'identity') {
    throw D__projects_webrtc_node_modules_httpErrors(415, 'content encoding unsupported', {
      encoding: encoding,
      type: 'encoding.unsupported'
    })
  }
  ...
  switch (encoding) {
    ...
    case 'identity':
      ...
      break
    default:
      throw D__projects_webrtc_node_modules_httpErrors(415, 'unsupported content encoding "' + encoding + '"', {
        encoding: encoding,
        type: 'encoding.unsupported'
      })
  }
...
var D__projects_webrtc_node_modules_mediaTyper = {
	format: format_1$2,
	parse: parse_1$2
};
...
var D__projects_webrtc_node_modules_mimeDb = require$$0$1;

var D__projects_webrtc_node_modules_mimeTypes = createCommonjsModule(function (module, exports) {
...
var extname = path$2__default.extname;
...
function charset (type) {
  ...
  var mime = match && D__projects_webrtc_node_modules_mimeDb[match[1].toLowerCase()];
...
function populateMaps (extensions, types) {
  ...
  Object.keys(D__projects_webrtc_node_modules_mimeDb).forEach(function forEachMimeType (type) {
    var mime = D__projects_webrtc_node_modules_mimeDb[type];
    ...
    for (var i = 0; i < exts.length; i++) {
      ...
      if (types[extension]) {
        var from = preference.indexOf(D__projects_webrtc_node_modules_mimeDb[types[extension]].source);
...
var D__projects_webrtc_node_modules_mimeTypes_1 = D__projects_webrtc_node_modules_mimeTypes.charset;
var D__projects_webrtc_node_modules_mimeTypes_2 = D__projects_webrtc_node_modules_mimeTypes.charsets;
var D__projects_webrtc_node_modules_mimeTypes_3 = D__projects_webrtc_node_modules_mimeTypes.contentType;
var D__projects_webrtc_node_modules_mimeTypes_4 = D__projects_webrtc_node_modules_mimeTypes.extension;
var D__projects_webrtc_node_modules_mimeTypes_5 = D__projects_webrtc_node_modules_mimeTypes.extensions;
var D__projects_webrtc_node_modules_mimeTypes_6 = D__projects_webrtc_node_modules_mimeTypes.lookup;
var D__projects_webrtc_node_modules_mimeTypes_7 = D__projects_webrtc_node_modules_mimeTypes.types;
...
var D__projects_webrtc_node_modules_typeIs = typeofrequest;
var is = typeis;
var hasBody = hasbody;
...
function normalize (type) {
  ...
  return type.indexOf('/') === -1
    ? D__projects_webrtc_node_modules_mimeTypes.lookup(type)
    : type
}
...
function normalizeType (value) {
  // parse the type
  var type = D__projects_webrtc_node_modules_mediaTyper.parse(value);

  // remove the parameters
  type.parameters = undefined;

  // reformat it
  return D__projects_webrtc_node_modules_mediaTyper.format(type)
}
...
D__projects_webrtc_node_modules_typeIs.is = is;
D__projects_webrtc_node_modules_typeIs.hasBody = hasBody;
D__projects_webrtc_node_modules_typeIs.normalize = normalize_1;
D__projects_webrtc_node_modules_typeIs.match = match;

var D__projects_webrtc_node_modules_bodyParser_node_modules_debug_src = createCommonjsModule(function (module) {
/**
 * Detect Electron renderer process, which is node, but we should
 * treat as a browser.
 */
...
var debug$1 = D__projects_webrtc_node_modules_bodyParser_node_modules_debug_src('body-parser:json');
...
function json (options) {
  ...
  var limit = typeof opts.limit !== 'number'
    ? D__projects_webrtc_node_modules_bytes.parse(opts.limit || '100kb')
    : opts.limit;
  ...
  return function jsonParser (req, res, next) {
    ...
    if (!D__projects_webrtc_node_modules_typeIs.hasBody(req)) {
    ...
    if (charset.substr(0, 4) !== 'utf-') {
      ...
      next(D__projects_webrtc_node_modules_httpErrors(415, 'unsupported charset "' + charset.toUpperCase() + '"', {
        charset: charset,
        type: 'charset.unsupported'
      }));
      return
...
function getCharset (req) {
  try {
    return (D__projects_webrtc_node_modules_contentType.parse(req).parameters.charset || '').toLowerCase()
  } catch (e) {
    return undefined
  }
}
...
function typeChecker (type) {
  return function checkType (req) {
    return Boolean(D__projects_webrtc_node_modules_typeIs(req, type))
  }
}
...
var debug$2 = D__projects_webrtc_node_modules_bodyParser_node_modules_debug_src('body-parser:raw');
...
var debug$3 = D__projects_webrtc_node_modules_bodyParser_node_modules_debug_src('body-parser:text');
...
var D__projects_webrtc_node_modules_qs_lib = {
    formats: formats,
    parse: parse$4,
...
var debug$4 = D__projects_webrtc_node_modules_bodyParser_node_modules_debug_src('body-parser:urlencoded');
var deprecate = D__projects_webrtc_node_modules_depd('body-parser');
...
function extendedparser (options) {
  ...
  return function queryparse (body) {
    ...
    if (paramCount === undefined) {
      ...
      throw D__projects_webrtc_node_modules_httpErrors(413, 'too many parameters', {
...
function parser (name) {
  ...
  switch (name) {
    case 'qs':
      mod = D__projects_webrtc_node_modules_qs_lib;
      break
    case 'querystring':
      mod = querystring;
      break
...
var D__projects_webrtc_node_modules_mergeDescriptors = merge$1;
...
var D__projects_webrtc_node_modules_finalhandler_node_modules_ms = function(val, options) {
  options = options || {};
  var type = typeof val;
  if (type === 'string' && val.length > 0) {
    return parse$5(val);
...
exports.enable = enable;
exports.enabled = enabled;
exports.humanize = D__projects_webrtc_node_modules_finalhandler_node_modules_ms;
...
var D__projects_webrtc_node_modules_encodeurl = encodeUrl;
...
var D__projects_webrtc_node_modules_escapeHtml = escapeHtml;
...
var D__projects_webrtc_node_modules_parseurl = parseurl;
...
D__projects_webrtc_node_modules_parseurl.original = original;

var D__projects_webrtc_node_modules_finalhandler_node_modules_debug_src = createCommonjsModule(function (module) {
/**
 * Detect Electron renderer process, which is node, but we should
 * treat as a browser.
 */
...
var debug$6 = D__projects_webrtc_node_modules_finalhandler_node_modules_debug_src('finalhandler');
...
var defer$1 = typeof setImmediate === 'function'
  ? setImmediate
  : function (fn) { process.nextTick(fn.bind.apply(fn, arguments)); };
var isFinished$1 = D__projects_webrtc_node_modules_onFinished.isFinished;
...
function createHtmlDocument (message) {
  var body = D__projects_webrtc_node_modules_escapeHtml(message)
...
var D__projects_webrtc_node_modules_finalhandler = finalhandler;
...
function finalhandler (req, res, options) {
  ...
  return function (err) {
    ...
    if (err) {
      ...
      // not found
      status = 404;
      msg = 'Cannot ' + req.method + ' ' + D__projects_webrtc_node_modules_encodeurl(getResourceName(req));
    }
...
function getErrorMessage (err, status, env) {
  ...
  return msg || D__projects_webrtc_node_modules_statuses[status]
}
...
function getResourceName (req) {
  try {
    return D__projects_webrtc_node_modules_parseurl.original(req).pathname
  } catch (e) {
    return 'resource'
  }
}
...
function send (req, res, status, headers, message) {
  function write () {
    ...
    res.statusMessage = D__projects_webrtc_node_modules_statuses[status];
  ...
  D__projects_webrtc_node_modules_unpipe(req);

  // flush the request
  D__projects_webrtc_node_modules_onFinished(req, write);
  req.resume();
}
...
var D__projects_webrtc_node_modules_express_node_modules_ms = function(val, options) {
  options = options || {};
  var type = typeof val;
  if (type === 'string' && val.length > 0) {
    return parse$7(val);
...
exports.enable = enable;
exports.enabled = enabled;
exports.humanize = D__projects_webrtc_node_modules_express_node_modules_ms;
...
var D__projects_webrtc_node_modules_pathToRegexp = pathtoRegexp;
...
var D__projects_webrtc_node_modules_express_node_modules_debug_src = createCommonjsModule(function (module) {
/**
 * Detect Electron renderer process, which is node, but we should
 * treat as a browser.
 */
...
var debug$8 = D__projects_webrtc_node_modules_express_node_modules_debug_src('express:router:layer');
...
function Layer(path, options, fn) {
  ...
  this.path = undefined;
  this.regexp = D__projects_webrtc_node_modules_pathToRegexp(path, this.keys = [], opts);
...
var D__projects_webrtc_node_modules_methods = getCurrentNodeMethods() || getBasicNodeMethods();
...
var debug$9 = D__projects_webrtc_node_modules_express_node_modules_debug_src('express:router:route');
...
D__projects_webrtc_node_modules_methods.forEach(function(method){
...
var D__projects_webrtc_node_modules_utilsMerge = createCommonjsModule(function (module, exports) {
/**
...
var D__projects_webrtc_node_modules_express_lib_router = createCommonjsModule(function (module) {
...
var debug = D__projects_webrtc_node_modules_express_node_modules_debug_src('express:router');
var deprecate = D__projects_webrtc_node_modules_depd('express');
...
D__projects_webrtc_node_modules_methods.concat('all').forEach(function(method){
...
function getPathname(req) {
  try {
    return D__projects_webrtc_node_modules_parseurl(req).pathname;
  } catch (err) {
    return undefined;
  }
}
...
function mergeParams(params, parent) {
  ...
  var obj = D__projects_webrtc_node_modules_utilsMerge({}, parent);

  // simple non-numeric merging
  if (!(0 in params) || !(0 in parent)) {
    return D__projects_webrtc_node_modules_utilsMerge(obj, params);
  }
...
var query = function query(options) {
  var opts = D__projects_webrtc_node_modules_utilsMerge({}, options);
  var queryparse = D__projects_webrtc_node_modules_qs_lib.parse;
  ...
  return function query(req, res, next){
    if (!req.query) {
      var val = D__projects_webrtc_node_modules_parseurl(req).query;
...
var debug$a = D__projects_webrtc_node_modules_express_node_modules_debug_src('express:view');
var path = path$2__default;
...
var D__projects_webrtc_node_modules_contentDisposition = contentDisposition;
...
var basename$1 = path$2__default.basename;
...
D__projects_webrtc_node_modules_contentDisposition.parse = parse_1$3;
...
var D__projects_webrtc_node_modules_send_node_modules_debug_node_modules_ms = function(val, options) {
  options = options || {};
  var type = typeof val;
  if (type === 'string' && val.length > 0) {
    return parse$9(val);
...
exports.enable = enable;
exports.enabled = enabled;
exports.humanize = D__projects_webrtc_node_modules_send_node_modules_debug_node_modules_ms;
...
var D__projects_webrtc_node_modules_destroy = destroy;
...
var D__projects_webrtc_node_modules_etag = etag;
...
var D__projects_webrtc_node_modules_fresh = fresh$1;
...
var D__projects_webrtc_node_modules_send_node_modules_ms = function(val, options) {
  options = options || {};
  var type = typeof val;
  if (type === 'string' && val.length > 0) {
    return parse$a(val);
...
var D__projects_webrtc_node_modules_send_node_modules_debug_src = createCommonjsModule(function (module) {
/**
 * Detect Electron renderer process, which is node, but we should
 * treat as a browser.
 */
...
// Default instance
var mime$1 = new Mime$1();

// Define built-in types
mime$1.define(require$$0$2);
...
var D__projects_webrtc_node_modules_rangeParser = rangeParser;
...
var debug$c = D__projects_webrtc_node_modules_send_node_modules_debug_src('send');
var deprecate$1 = D__projects_webrtc_node_modules_depd('send');
...
var D__projects_webrtc_node_modules_send = send$1;
var mime_1$1 = mime_1;
...
function SendStream (req, path, options) {
  ...
  this._maxage = typeof this._maxage === 'string'
    ? D__projects_webrtc_node_modules_send_node_modules_ms(this._maxage)
    : Number(this._maxage);
...
SendStream.prototype.maxage = deprecate$1.function(function maxage (maxAge) {
  this._maxage = typeof maxAge === 'string'
    ? D__projects_webrtc_node_modules_send_node_modules_ms(maxAge)
    : Number(maxAge);
  this._maxage = !isNaN(this._maxage)
    ? Math.min(Math.max(0, this._maxage), MAX_MAXAGE)
    : 0;
...
SendStream.prototype.error = function error (status, err) {
  ...
  if (hasListeners(this, 'error')) {
    return this.emit('error', D__projects_webrtc_node_modules_httpErrors(status, err, {
      expose: false
    }))
  }

  var res = this.res;
  var msg = D__projects_webrtc_node_modules_statuses[status] || String(status);
  var doc = createHtmlDocument$1('Error', D__projects_webrtc_node_modules_escapeHtml(msg));
...
SendStream.prototype.isFresh = function isFresh () {
  return D__projects_webrtc_node_modules_fresh(this.req.headers, {
...
SendStream.prototype.redirect = function redirect (path) {
  ...
  var loc = D__projects_webrtc_node_modules_encodeurl(collapseLeadingSlashes(this.path + '/'));
  var doc = createHtmlDocument$1('Redirecting', 'Redirecting to <a href="' + D__projects_webrtc_node_modules_escapeHtml(loc) + '">' +
    D__projects_webrtc_node_modules_escapeHtml(loc) + '</a>');
...
SendStream.prototype.send = function send (path, stat) {
  ...
  if (this._acceptRanges && BYTES_RANGE_REGEXP.test(ranges)) {
    // parse
    ranges = D__projects_webrtc_node_modules_rangeParser(len, ranges, {
      combine: true
    });
...
SendStream.prototype.stream = function stream (path, options) {
  ...
  D__projects_webrtc_node_modules_onFinished(res, function onfinished () {
    finished = true;
    D__projects_webrtc_node_modules_destroy(stream);
  });
...
SendStream.prototype.setHeader = function setHeader (path, stat) {
  ...
  if (this._etag && !res.getHeader('ETag')) {
    var val = D__projects_webrtc_node_modules_etag(stat);
    debug$c('etag %s', val);
...
D__projects_webrtc_node_modules_send.mime = mime_1$1;
...
var D__projects_webrtc_node_modules_forwarded = forwarded;
...
var D__projects_webrtc_node_modules_proxyAddr = proxyaddr;
var all = alladdrs;
...
function alladdrs (req, trust) {
  // get addresses
  var addrs = D__projects_webrtc_node_modules_forwarded(req);
...
D__projects_webrtc_node_modules_proxyAddr.all = all;
D__projects_webrtc_node_modules_proxyAddr.compile = compile_1;
...
var mime = D__projects_webrtc_node_modules_send.mime;
...
exports.contentDisposition = deprecate.function(D__projects_webrtc_node_modules_contentDisposition,
...
exports.compileTrust = function(val) {
  ...
  return D__projects_webrtc_node_modules_proxyAddr.compile(val || []);
};
...
exports.setCharset = function setCharset(type, charset) {
  ...
  // parse type
  var parsed = D__projects_webrtc_node_modules_contentType.parse(type);

  // set charset
  parsed.parameters.charset = charset;

  // format type
  return D__projects_webrtc_node_modules_contentType.format(parsed);
};
...
function createETagGenerator (options) {
  return function generateETag (body, encoding) {
    ...
    return D__projects_webrtc_node_modules_etag(buf, options)
  }
}
...
function parseExtendedQueryString(str) {
  return D__projects_webrtc_node_modules_qs_lib.parse(str, {
    allowPrototypes: true
  });
}
...
var debug = D__projects_webrtc_node_modules_express_node_modules_debug_src('express:application');
...
var resolve = path$2__default.resolve;
...
app.lazyrouter = function lazyrouter() {
  if (!this._router) {
    this._router = new D__projects_webrtc_node_modules_express_lib_router({
...
app.handle = function handle(req, res, callback) {
  ...
  // final handler
  var done = callback || D__projects_webrtc_node_modules_finalhandler(req, res, {
    env: this.get('env'),
...
app.all = function all(path) {
  ...
  for (var i = 0; i < D__projects_webrtc_node_modules_methods.length; i++) {
    route[D__projects_webrtc_node_modules_methods[i]].apply(route, args);
  }
...
app.render = function render(name, options, callback) {
  ...
  // merge app.locals
  D__projects_webrtc_node_modules_utilsMerge(renderOptions, this.locals);

  // merge options._locals
  if (opts._locals) {
    D__projects_webrtc_node_modules_utilsMerge(renderOptions, opts._locals);
  }

  // merge options
  D__projects_webrtc_node_modules_utilsMerge(renderOptions, opts);
...
var D__projects_webrtc_node_modules_negotiator = Negotiator;
...
D__projects_webrtc_node_modules_negotiator.Negotiator = Negotiator_1;
...
var D__projects_webrtc_node_modules_accepts = Accepts;
...
function Accepts (req) {
  ...
  this.negotiator = new D__projects_webrtc_node_modules_negotiator(req);
}
...
var deprecate$2 = D__projects_webrtc_node_modules_depd('express');
var isIP = net.isIP;
...
req.accepts = function(){
  var accept = D__projects_webrtc_node_modules_accepts(this);
...
req.range = function range(size, options) {
  ...
  if (!range) return;
  return D__projects_webrtc_node_modules_rangeParser(size, range, options);
};
...
req.is = function is(types) {
  ...
  return D__projects_webrtc_node_modules_typeIs(this, arr);
};
...
defineGetter(req, 'ip', function ip(){
  var trust = this.app.get('trust proxy fn');
  return D__projects_webrtc_node_modules_proxyAddr(this, trust);
});
...
defineGetter(req, 'ips', function ips() {
  var trust = this.app.get('trust proxy fn');
  var addrs = D__projects_webrtc_node_modules_proxyAddr.all(this, trust);
...
defineGetter(req, 'path', function path() {
  return D__projects_webrtc_node_modules_parseurl(this).pathname;
});
...
defineGetter(req, 'fresh', function(){
  ...
  if ((status >= 200 && status < 300) || 304 === status) {
    return D__projects_webrtc_node_modules_fresh(this.headers, {
      'etag': res.get('ETag'),
...
var D__projects_webrtc_node_modules_cookieSignature = createCommonjsModule(function (module, exports) {
/**
 * Module dependencies.
 */
...
var D__projects_webrtc_node_modules_cookieSignature_1 = D__projects_webrtc_node_modules_cookieSignature.sign;
var D__projects_webrtc_node_modules_cookieSignature_2 = D__projects_webrtc_node_modules_cookieSignature.unsign;
...
var D__projects_webrtc_node_modules_cookie = {
	parse: parse_1$4,
...
var D__projects_webrtc_node_modules_vary = vary;
var append_1 = append;
...
D__projects_webrtc_node_modules_vary.append = append_1;
...
var deprecate$3 = D__projects_webrtc_node_modules_depd('express');
...
var sign = D__projects_webrtc_node_modules_cookieSignature.sign;
var normalizeType$1 = utils$1.normalizeType;
var normalizeTypes = utils$1.normalizeTypes;
var setCharset = utils$1.setCharset;


var extname$2 = path$2__default.extname;
var mime$2 = D__projects_webrtc_node_modules_send.mime;
var resolve$2 = path$2__default.resolve;
...
res.send = function send(body) {
  ...
  if (typeof chunk === 'number' && arguments.length === 1) {
    ...
    chunk = D__projects_webrtc_node_modules_statuses[chunk];
  }
...
res.sendStatus = function sendStatus(statusCode) {
  var body = D__projects_webrtc_node_modules_statuses[statusCode] || String(statusCode);
...
res.sendFile = function sendFile(path, options, callback) {
  ...
  var file = D__projects_webrtc_node_modules_send(req, pathname, opts);
...
res.sendfile = function (path, options, callback) {
  ...
  // create file stream
  var file = D__projects_webrtc_node_modules_send(req, path, opts);
...
res.download = function download (path, filename, options, callback) {
  ...
  var headers = {
    'Content-Disposition': D__projects_webrtc_node_modules_contentDisposition(name || path)
  };
...
res.attachment = function attachment(filename) {
  ...
  this.set('Content-Disposition', D__projects_webrtc_node_modules_contentDisposition(filename));
  ...
  if (arguments.length === 2) {
    ...
    if (field.toLowerCase() === 'content-type') {
      ...
      if (!charsetRegExp.test(value)) {
        var charset = mime$2.charsets.lookup(value.split(';')[0]);
...
res.clearCookie = function clearCookie(name, options) {
  var opts = D__projects_webrtc_node_modules_utilsMerge({ expires: new Date(1), path: '/' }, options);
...
res.cookie = function (name, value, options) {
  ...
  this.append('Set-Cookie', D__projects_webrtc_node_modules_cookie.serialize(name, String(val), opts));
...
res.location = function location(url) {
  ...
  // set location
  return this.set('Location', D__projects_webrtc_node_modules_encodeurl(loc));
};
...
res.redirect = function redirect(url) {
  ...
  this.format({
    text: function(){
      body = D__projects_webrtc_node_modules_statuses[status] + '. Redirecting to ' + address;
    },

    html: function(){
      var u = D__projects_webrtc_node_modules_escapeHtml(address);
      body = '<p>' + D__projects_webrtc_node_modules_statuses[status] + '. Redirecting to <a href="' + u + '">' + u + '</a></p>';
    },
...
res.vary = function(field){
  ...
  D__projects_webrtc_node_modules_vary(this, field);
...
function sendfile(res, file, options, callback) {
  ...
  D__projects_webrtc_node_modules_onFinished(res, onfinish);
...
var resolve$3 = path$2__default.resolve;

var D__projects_webrtc_node_modules_bodyParser = createCommonjsModule(function (module, exports) {
...
var resolve$4 = path$2__default.resolve;
...
var D__projects_webrtc_node_modules_serveStatic = serveStatic;
var mime$3 = D__projects_webrtc_node_modules_send.mime;
...
function serveStatic (root, options) {
  ...
  return function serveStatic (req, res, next) {
    ...
    var originalUrl = D__projects_webrtc_node_modules_parseurl.original(req);
    var path = D__projects_webrtc_node_modules_parseurl(req).pathname;
    ...
    // create send stream
    var stream = D__projects_webrtc_node_modules_send(req, path, opts);
...
function createRedirectDirectoryListener () {
  return function redirect (res) {
    ...
    // get original URL
    var originalUrl = D__projects_webrtc_node_modules_parseurl.original(this.req);
    ...
    // reformat the URL
    var loc = D__projects_webrtc_node_modules_encodeurl(url.format(originalUrl));
    var doc = createHtmlDocument$2('Redirecting', 'Redirecting to <a href="' + D__projects_webrtc_node_modules_escapeHtml(loc) + '">' +
      D__projects_webrtc_node_modules_escapeHtml(loc) + '</a>');
...
D__projects_webrtc_node_modules_serveStatic.mime = mime$3;
...
function createApplication() {
  ...
  D__projects_webrtc_node_modules_mergeDescriptors(app, EventEmitter.prototype, false);
  D__projects_webrtc_node_modules_mergeDescriptors(app, application, false);
...
exports.Route = route;
exports.Router = D__projects_webrtc_node_modules_express_lib_router;

/**
 * Expose middleware
 */

exports.json = D__projects_webrtc_node_modules_bodyParser.json;
exports.query = query;
exports.raw = D__projects_webrtc_node_modules_bodyParser.raw;
exports.static = D__projects_webrtc_node_modules_serveStatic;
exports.text = D__projects_webrtc_node_modules_bodyParser.text;
exports.urlencoded = D__projects_webrtc_node_modules_bodyParser.urlencoded;
...
function findEncoding(acceptEncoding, availableCompressions, preference) {
    if (acceptEncoding) {
        let sortedEncodingList = parseEncoding$1(acceptEncoding);
 ...
 */
function parseEncoding$1(acceptedEncoding) {
...
var encodingSelection = {
    findEncoding: findEncoding
};

let sanitizeOptions$1 = options.sanitizeOptions;
let findEncoding$1 = encodingSelection.findEncoding;
let mime$4 = D__projects_webrtc_node_modules_serveStatic.mime;

var expressStaticGzip_1 = expressStaticGzip;
...
function expressStaticGzip(root, options) {
    ...
    let opts = sanitizeOptions$1(options);
    
    //create a express.static middleware to handle serving files 
    let defaultStatic = D__projects_webrtc_node_modules_serveStatic(root, opts.serveStatic || null);
    let compressions = [];
    let files = {};
    ...
    if (compressions.length > 0) {
        findAllCompressionFiles(fs__default, root);
    }
    ...
    return function expressStaticGzip(req, res, next) {
        ...
        if (matchedFile) {
            ...
            var compression = findEncoding$1(acceptEncoding, matchedFile.compressions, opts.orderPreference);
            if (compression) {
    ...
    function convertToCompressedRequest(req, res, compression) {
        var type = mime$4.lookup(req.path);
        var charset = mime$4.charsets.lookup(type);
...
const keyPath = process.env.KEY_PATH || getAbsolutePath('./ssl/test.key');
const crtPath = process.env.CRT_PATH || getAbsolutePath('./ssl/test.crt');
...
app.use('/', expressStaticGzip_1(staticPath, {
    enableBrotli: true
}));
app.use('/env.js', (req, res) => {
    res
        ...
        .status(200)
        .send(`(function(w){
    w['JANUS_SERVER']="${process.env.JANUS_SERVER || ''}";
})(window)`);
});
appServer.listen(port, () => console.log('Application listening on port %d', port));
function getAbsolutePath(relativePath) {
    return path$2.join(__dirname, './', relativePath);
}
